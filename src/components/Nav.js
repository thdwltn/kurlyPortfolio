...
import { FiCoffee,FiFeather,FiSun } from "react-icons/fi"
  ...
  useEffect(()=>{
    ...
    <nav className="sub">
      <ul>
        <li><BsList/>
          <ul className="nav">
            <li><Link><FiCoffee/> 샐러드</Link></li>
            <li><Link><FiFeather/> 대체육</Link></li>
            <li><Link><FiSun/> 대체유</Link></li>
            <li><Link><FiFeather/> 비건제품</Link></li>
          </ul>
        </li>
